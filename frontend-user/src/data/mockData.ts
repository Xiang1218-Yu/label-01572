...
const heroes = {
  jinx: { id: 'h1', name: '金克丝', description: '疯狂的爆破专家，擅长远程输出', avatarUrl: '/img/champion/Jinx.png', cost: 5 },
  vi: { id: 'h2', name: '蔚', description: '皮城执法官，近战坦克战士', avatarUrl: '/img/champion/Vi.png', cost: 4 },
  caitlyn: { id: 'h3', name: '凯特琳', description: '皮城女警，精准射手', avatarUrl: '/img/champion/Caitlyn.png', cost: 4 },
  jayce: { id: 'h4', name: '杰斯', description: '未来守护者，远近双形态', avatarUrl: '/img/champion/Jayce.png', cost: 5 },
  ekko: { id: 'h5', name: '艾克', description: '时间刺客，灵活突进', avatarUrl: '/img/champion/Ekko.png', cost: 3 },
  yasuo: { id: 'h6', name: '亚索', description: '疾风剑豪，暴击战士', avatarUrl: '/img/champion/Yasuo.png', cost: 5 },
  zed: { id: 'h7', name: '劫', description: '影流之主，高爆发刺客', avatarUrl: '/img/champion/Zed.png', cost: 4 },
  ahri: { id: 'h8', name: '阿狸', description: '九尾妖狐，魔法输出', avatarUrl: '/img/champion/Ahri.png', cost: 4 },
  lux: { id: 'h9', name: '拉克丝', description: '光辉女郎，控制法师', avatarUrl: '/img/champion/Lux.png', cost: 3 },
  garen: { id: 'h10', name: '盖伦', description: '德玛西亚之力，前排坦克', avatarUrl: '/img/champion/Garen.png', cost: 1 },
  darius: { id: 'h11', name: '德莱厄斯', description: '诺克萨斯之手，战场统治者', avatarUrl: '/img/champion/Darius.png', cost: 3 },
  kaisa: { id: 'h12', name: '卡莎', description: '虚空之女，自适应射手', avatarUrl: '/img/champion/Kaisa.png', cost: 4 },
  thresh: { id: 'h13', name: '锤石', description: '魂锁典狱长，控制辅助', avatarUrl: '/img/champion/Thresh.png', cost: 2 },
  leona: { id: 'h14', name: '蕾欧娜', description: '曙光女神，坚韧前排', avatarUrl: '/img/champion/Leona.png', cost: 1 },
  morgana: { id: 'h15', name: '莫甘娜', description: '堕落天使，控制法师', avatarUrl: '/img/champion/Morgana.png', cost: 3 },
  senna: { id: 'h16', name: '赛娜', description: '暗影哨兵，远程辅助', avatarUrl: '/img/champion/Senna.png', cost: 2 },
  aphelios: { id: 'h17', name: '厄斐琉斯', description: '残月之肃，多武器射手', avatarUrl: '/img/champion/Aphelios.png', cost: 4 },
  sett: { id: 'h18', name: '瑟提', description: '腕豪，近战格斗家', avatarUrl: '/img/champion/Sett.png', cost: 3 },
  irelia: { id: 'h19', name: '艾瑞莉娅', description: '刀锋舞者，灵活战士', avatarUrl: '/img/champion/Irelia.png', cost: 4 },
  talon: { id: 'h20', name: '泰隆', description: '刀锋之影，高机动刺客', avatarUrl: '/img/champion/Talon.png', cost: 3 },
};
